...
adicionar_business('Studio Verde', 'O Studio Verde é um espaço de jardinagem e paisagismo que transforma qualquer ambiente em um refúgio natural. Oferecemos consultoria, projetos personalizados e manutenção de jardins, buscando sempre integrar estética, sustentabilidade e praticidade. Nosso objetivo é proporcionar bem-estar e qualidade de vida por meio do contato com a natureza.', 'Serviços', '@studioverde', '(21) 91234-5670', 'contato@studioverde.com', None, 9, -12.9750, -38.5025)
